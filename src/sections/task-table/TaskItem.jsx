    ...
    return (
        <>
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                ...
                <Table.Cell>
                    <button onClick={() => setOpenEditModal(true)} className="font-medium text-cyan-600 hover:underline dark:text-cyan-500 mr-3">
                        Edit
                    </button>
                    <button
            ...
            {/* Edit Modal */}
            <ModalPopup taskToEdit={props.data} onEdit={editHandler} onOpen={openEditModal} onClose={() => setOpenEditModal(false)} />
